...
{ lib, pkgs, config, ... }:
{
  options.global.terminal = lib.mkOption {
    type = lib.types.path;
    description = "The path to the primary terminal emulator executable";
  };
      ...
      home-manager.users.julius =
        { ... }:
        {
          xdg.configFile."xfce4/xfconf/xfce-perchannel-xml/xfce4-keyboard-shortcuts.xml".text =
            builtins.replaceStrings ["TERMINAL_EMULATOR"] [cfg.terminal] (builtins.readFile ./xfce_keyboard.xml);
